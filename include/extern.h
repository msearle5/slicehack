...
E void FDECL(destroy_wand, (struct obj *, boolean));
...
E void FDECL(dropzat, (struct obj *, BOOLEAN_P, int, int));
...
E int FDECL(get_dog_nutrition, (struct monst *, struct obj *, int *));
...
E void FDECL(mayhitfloor, (struct obj *, boolean, int, int, boolean));
...
E void NDECL(vomit);
E boolean FDECL(is_inedible_pet, (int));
E boolean FDECL(is_cannibal, (int));
...
E boolean FDECL(cangivit, (int, struct permonst *, BOOLEAN_P));
...
E int FDECL(gen_frequency, (struct permonst *ptr));
...
E int FDECL(zombie_target, (struct permonst *));
...
E void FDECL(mondead, (struct monst *, struct monst *));
E void FDECL(mondied, (struct monst *, struct monst *));
E void FDECL(mongone, (struct monst *));
E void FDECL(monstone, (struct monst *));
E void FDECL(monkilled, (struct monst *, struct monst *, const char *, int));
...
E char *FDECL(doname_inv, (struct obj *));
E char *FDECL(doname_inv_with_price, (struct obj *));
...
E int NDECL(doturn);
E int FDECL(turn_undead, (struct obj *));
E void FDECL(use_holy_symbol, (struct obj *));
E boolean NDECL(holy_symbol);
E int FDECL(turn_undead, (struct obj *));
...
E int NDECL(doread);
E const char *FDECL(scrollname, (void));
...
E boolean FDECL(validrace, (int, int, int));
E boolean FDECL(validgend, (int, int, int, int));
E boolean FDECL(validalign, (int, int, int, int));
E int FDECL(randrole, (BOOLEAN_P));
E int NDECL(randsubrole);
E int FDECL(randrace, (int, int));
E int FDECL(randgend, (int, int, int));
E int FDECL(randalign, (int, int, int));
E int FDECL(str2subrole, (const char *));
...
E boolean FDECL(ok_subrole, (int, int, int, int, int));
E int FDECL(pick_subrole, (int, int, int, int, int));
E boolean FDECL(ok_role, (int, int, int, int, int));
E int FDECL(pick_role, (int, int, int, int, int));
E boolean FDECL(ok_race, (int, int, int, int, int));
E int FDECL(pick_race, (int, int, int, int, int));
E boolean FDECL(ok_gend, (int, int, int, int, int));
E int FDECL(pick_gend, (int, int, int, int, int));
E boolean FDECL(ok_align, (int, int, int, int, int));
E int FDECL(pick_align, (int, int, int, int, int));
E void NDECL(rigid_role_checks);
E boolean NDECL(gotsubrolefilter);
E boolean FDECL(setsubrolefilter, (const char *));
E void NDECL(clearsubrolefilter);
E boolean FDECL(setrolefilter, (const char *));
E boolean NDECL(gotrolefilter);
E void NDECL(clearrolefilter);
E boolean FDECL(has_subroles, (int, int, int, int));
...
E void FDECL(distribute_contents, (struct obj *));
...
E boolean climbable_trap(struct trap *t);
