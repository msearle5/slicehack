...
STATIC_OVL NEARDATA struct artifact artilist[] = {
   ...
   /*
    *      Wizardstaff that grants teleport control, and also greatly increases
    ...
    */
    ...
    A("Demonbane", LONG_SWORD, (SPFX_WARN | SPFX_RESTR | SPFX_DFLAGH), 0, M2_DEMON,
      PHYS(8,20), DRLI(0,0), NO_CARY, 0, A_LAWFUL, NON_PM, NON_PM, 2750L,
      CLR_RED),

    A("Werebane", SABER, (SPFX_WARN | SPFX_RESTR | SPFX_DFLAGH), 0, M2_WERE,
    ...
    A("Giantslayer", LONG_SWORD, (SPFX_WARN | SPFX_RESTR | SPFX_DFLAGH), 0, M2_GIANT,
    ...
    A("Sunsword", LONG_SWORD, (SPFX_BLIND | SPFX_WARN | SPFX_RESTR | SPFX_DFLAGH), 0, M2_UNDEAD,
