...
#define MON(nam, sym, lvl, gen, atk, siz, mr1, mr2, flg1, flg2, flg3, col) \
    {                                                                      \
        nam, sym, lvl, gen, atk, siz, mr1, mr2, flg1, flg2, flg3, 0, C(col)   \
    }
#define MON4(nam, sym, lvl, gen, atk, siz, mr1, mr2, flg1, flg2, flg3, flg4, col) \
    {                                                                      \
...
NEARDATA struct permonst mons[] = {
     ...
     * blobs
     */
    MON4("acid blob", S_BLOB, LVL(1, 3, 8, 0, 0), (G_GENO | 2),
        ...
        M1_BREATHLESS | M1_AMORPHOUS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD
            | M1_MINDLESS | M1_ACID,
        M2_WANDER | M2_NEUTER, 0, M4_VEGAN, CLR_GREEN),
    MON4("quivering blob", S_BLOB, LVL(5, 1, 8, 0, 0), (G_GENO | 2),
        ...
        M2_WANDER | M2_HOSTILE | M2_NEUTER, 0, M4_VEGAN, CLR_WHITE),
    MON4("gelatinous cube", S_BLOB, LVL(6, 6, 8, 0, 0), (G_GENO | 2),
    ...
    MON("memory hound", S_DOG, LVL(7, 12, 2, 0, 3), (G_GENO | 2),
        A(ATTK(AT_BITE, AD_MEMR, 3, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(250, 200, MS_BARK, MZ_SMALL), MR_COLD, MR_COLD,
        M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISION | M3_SUMMONABLE, CLR_BLUE),
    ...
    MON("floating eye", S_EYE, LVL(2, 1, 9, 10, 0), (G_GENO | 3),
        ...
        M2_HOSTILE | M2_NEUTER, M3_INFRAVISIBLE | M3_WIZAPP | M3_ONEEYE |
        M3_TELEPATHIC, CLR_BLUE),
    MON("weeping eye", S_EYE, LVL(2, 1, 9, 10, 0), (G_GENO | 2),
        A(ATTK(AT_NONE, AD_RUST, 0, 70), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(10, 10, MS_SILENT, MZ_SMALL), 0, 0,
        M1_FLY | M1_AMPHIBIOUS | M1_NOLIMBS | M1_NOHEAD | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER, M3_INFRAVISIBLE | M3_ONEEYE, CLR_BROWN),
    MON("glowing eye", S_EYE, LVL(5, 3, 4, 0, 0), (G_NOHELL|G_GENO|1),
        ...
        M2_HOSTILE | M2_NEUTER, M3_ONEEYE, CLR_YELLOW),
    ...
    MON("flaming sphere", S_EYE, LVL(6, 13, 4, 0, 0),
        ...
        M1_FLY | M1_BREATHLESS | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER, M3_INFRAVISIBLE | M3_FLAMING, CLR_RED),
    ...
    MON("bloodshot eye", S_EYE, LVL(6, 3, 4, 0, 0), (G_NOHELL | G_GENO | 1),
      	...
      	SIZ(10, 10, MS_SILENT, MZ_SMALL), 0, 0,
      	M1_FLY | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS,
      	M2_HOSTILE | M2_NEUTER, M3_INFRAVISIBLE | M3_ONEEYE, CLR_BRIGHT_MAGENTA),
    MON("blinking eye", S_EYE, LVL(8, 12, 4, 0, 0), (G_NOHELL | G_GENO | 1),
      	...
      	M2_HOSTILE | M2_NEUTER, M3_INFRAVISIBLE | M3_ONEEYE, CLR_CYAN),
    ...
    MON("beholder", S_EYE,
        ...
        M1_FLY | M1_BREATHLESS | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS,
        M2_NOPOLY | M2_HOSTILE | M2_NEUTER, M3_INFRAVISIBLE | M3_ONEEYE, CLR_BROWN),
#endif
    /*
     * felines
     */
    ...
    MON("cheshire cat", S_FELINE, LVL(7, 12, 3, 20, -1), (G_HELL | 1),
        ...
        M3_INFRAVISIBLE | M3_DISPLACED, CLR_BRIGHT_MAGENTA),
    MON4("hellcat", S_FELINE, LVL(12, 12, 6, 0, 0), (G_HELL | G_GENO | 2),
    ...
    MON("winged gargoyle", S_GREMLIN, LVL(9, 15, -2, 0, -12), (G_GENO | 1),
        ...
        M2_LORD | M2_HOSTILE | M2_STRONG | M2_MAGIC, M3_SUMMONABLE, HI_LORD),
    /*
     * humanoids
     */
    ...
    MON("mind flayer", S_HUMANOID, LVL(9, 12, 5, 90, -8), (G_GENO | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_TELEPATHIC | M3_MINDFLAYER,
        CLR_MAGENTA),
    ...
    MON("master mind flayer", S_HUMANOID, LVL(13, 12, 0, 90, -8),
        ...
        M1_HUMANOID | M1_FLY | M1_SEE_INVIS | M1_OMNIVORE,
        M2_HOSTILE | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_SUMMONABLE | M3_TELEPATHIC | M3_MINDFLAYER,
        CLR_MAGENTA),
    MON("planar pirate", S_HUMANOID, LVL(15, 16, -7, 0, 0),
        ...
        M3_INFRAVISION | M3_PIRATE, CLR_WHITE),
    ...
    MON("dust devil", S_IMP, LVL(6, 20, -6, 20, 11),
        ...
        M2_NASTY, M3_SUMMONABLE, CLR_YELLOW),
    /*
     * jellies
     */
    MON4("blue jelly", S_JELLY, LVL(4, 0, 8, 10, 0), (G_GENO | 2),
        ...
        M2_HOSTILE | M2_NEUTER, 0, M4_VEGAN, CLR_BLUE),
    MON4("spotted jelly", S_JELLY, LVL(5, 0, 8, 10, 0), (G_GENO | 1),
        ...
        M2_HOSTILE | M2_NEUTER, 0, M4_VEGAN, CLR_GREEN),
    MON4("ochre jelly", S_JELLY, LVL(6, 3, 8, 20, 0), (G_GENO | 2),
        A(ATTK(AT_ENGL, AD_ACID, 3, 6), ATTK(AT_NONE, AD_ACID, 3, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(50, 20, MS_SILENT, MZ_MEDIUM), MR_ACID | MR_STONE, 0,
        M1_BREATHLESS | M1_AMORPHOUS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD
            | M1_MINDLESS | M1_ACID | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER, M3_SUMMONABLE, M4_VEGAN, CLR_BROWN),
    /*
     * kobolds
     */
    ...
    /*
     * Lemmings.
     * These are rodents, but roughly humanoid - sufficiently to use most items (e.g. a fire card).
     ...
     * Break wands? If so, give them some? And fire cards (not just for volcano, but especially plains)
     */
    MON("green lemming", S_LEMMING, LVL(0, 12, 10, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 2), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(150, 50, MS_LEMMING, MZ_SMALL), 0, 0, M1_HUMANOID | M1_HERBIVORE,
        M2_HOSTILE, M3_INFRAVISIBLE, CLR_GREEN),
    MON("blue lemming", S_LEMMING, LVL(1, 12, 10, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 3), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
     ...
     **/
    MON("gully lemming", S_LEMMING, LVL(2, 10, 5, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 3), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(200, 70, MS_LEMMING, MZ_SMALL), 0, 0, M1_HIDE | M1_HUMANOID | M1_HERBIVORE,
        M2_HOSTILE | M2_COLLECT | M2_GREEDY | M2_JEWELS, M3_INFRAVISIBLE | M3_WANTSALL, CLR_BLACK),
    /* This is supposed to explode in some way - as a passive attack, or on death? */
    MON("plains lemming", S_LEMMING, LVL(3, 12, 10, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(200, 70, MS_LEMMING, MZ_SMALL), 0, 0, M1_TUNNEL | M1_NEEDPICK | M1_HUMANOID | M1_HERBIVORE,
        M2_HOSTILE | M2_STRONG, M3_INFRAVISIBLE, CLR_ORANGE),
    MON4("lemming shaman", S_LEMMING, LVL(4, 12, 10, 40, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 3), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(170, 60, MS_LEMMING, MZ_SMALL), 0, 0, M1_HUMANOID | M1_HERBIVORE,
        M2_HOSTILE, M3_INFRAVISIBLE, M4_SUMMONER, CLR_YELLOW),
    MON("bungee lemming", S_LEMMING, LVL(4, 6, 10, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(280, 100, MS_LEMMING, MZ_SMALL), 0, 0, M1_HUMANOID | M1_OMNIVORE,
        M2_HOSTILE, M3_INFRAVISIBLE | M3_JUMPER, CLR_GRAY),
    MON("horde lemming", S_LEMMING, LVL(5, 12, 10, 0, 0), (G_GENO | G_LGROUP | G_SGROUP | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(170, 60, MS_LEMMING, MZ_SMALL), 0, 0, M1_HUMANOID | M1_HERBIVORE,
        M2_HOSTILE, M3_INFRAVISIBLE, CLR_CYAN),
    MON4("highland lemming", S_LEMMING, LVL(5, 12, 10, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(280, 100, MS_LEMMING, MZ_SMALL), 0, 0, M1_REGEN | M1_HUMANOID | M1_HERBIVORE,
        M2_HOSTILE, M3_INFRAVISIBLE, M4_REVIVE, CLR_BROWN),
    MON("lemming aviator", S_LEMMING, LVL(6, 16, 10, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(170, 60, MS_LEMMING, MZ_SMALL), 0, 0, M1_FLY | M1_HUMANOID | M1_HERBIVORE,
        M2_HOSTILE, M3_INFRAVISIBLE, CLR_BRIGHT_CYAN),
    MON4("shadow lemming", S_LEMMING, LVL(6, 12, 10, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 6), ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(200, 70, MS_LEMMING, MZ_SMALL), 0, 0, M1_HIDE | M1_HUMANOID | M1_HERBIVORE,
        M2_HOSTILE, M3_INFRAVISIBLE, M4_HATESLIGHT, CLR_BLACK),
    MON("pit lemming", S_LEMMING, LVL(7, 12, 10, 0, 0), (G_GENO | 1),
    ...
    MON("hill lemming", S_LEMMING, LVL(9, 12, 10, 0, 0), (G_GENO | 1),
    ...
    MON4("master lemming", S_LEMMING, LVL(12, 12, 10, 40, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 6), ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(170, 60, MS_LEMMING, MZ_SMALL), MR_SLEEP, MR_SLEEP, M1_HUMANOID | M1_HERBIVORE,
        M2_LORD | M2_HOSTILE, M3_INFRAVISIBLE, M4_SUMMONER, CLR_MAGENTA),
    MON("mountain lemming", S_LEMMING, LVL(13, 12, 10, 0, 0), (G_GENO | G_SGROUP | 1),
        ...
        M2_HOSTILE, M3_INFRAVISIBLE, CLR_GRAY),
    MON("desert lemming", S_LEMMING, LVL(14, 12, 10, 0, 0), (G_GENO | 1),
    ...
    MON("volcano lemming", S_LEMMING, LVL(15, 12, 10, 0, 0), (G_GENO | 1),
    ...
    MON4("peak lemming", S_LEMMING, LVL(16, 12, 10, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_COLD, 1, 12), ATTK(AT_CLAW, AD_PHYS, 1, 8), ATTK(AT_CLAW, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(260, 110, MS_LEMMING, MZ_SMALL), MR_COLD, MR_COLD, M1_HUMANOID | M1_HERBIVORE,
        M2_LORD | M2_HOSTILE, M3_INFRAVISIBLE, M4_SUMMONER, CLR_WHITE),
    MON("Superlemming", S_LEMMING, LVL(17, 24, 10, 0, 0), (G_UNIQ | 1),
        ...
        M2_LORD | M2_HOSTILE | M2_MALE | M2_STRONG, M3_INFRAVISION | M3_INFRAVISIBLE, CLR_BRIGHT_MAGENTA),
    MON("Cyberlemming", S_LEMMING, LVL(19, 24, 10, 0, 0), (G_UNIQ | 1),
        ...
        M2_LORD | M2_HOSTILE | M2_STRONG | M2_MALE, M3_INFRAVISION | M3_INFRAVISIBLE | M3_JUMPER, CLR_BRIGHT_BLUE),
    MON("Plummet's Champion", S_LEMMING, LVL(20, 12, 10, 0, 0), (G_UNIQ | 1),
        ...
        M2_PRINCE | M2_HOSTILE | M2_STRONG | M2_MALE, M3_INFRAVISIBLE, CLR_BRIGHT_GREEN),
    MON4("Plummet", S_LEMMING, LVL(20, 12, 10, 0, 0), (G_UNIQ | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 12), ATTK(AT_WEAP, AD_PHYS, 2, 10), ATTK(AT_WEAP, AD_PHYS, 2, 10),
        NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(280, 120, MS_LEMMING, MZ_SMALL), MR_COLD, 0, M1_HUMANOID | M1_HERBIVORE,
        M2_PRINCE | M2_HOSTILE | M2_STRONG | M2_MALE, M3_INFRAVISIBLE, M4_SUMMONER, HI_LORD),
     ...
     * nymphs
     * 
     * plain "nymph" for zombie corpses only; not created at random
     */
    MON("nymph", S_NYMPH, LVL(3, 12, 9, 20, 0), (G_GENO | G_NOGEN),
        A(ATTK(AT_CLAW, AD_SITM, 0, 0), ATTK(AT_CLAW, AD_SEDU, 0, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(600, 300, MS_SEDUCE, MZ_HUMAN), 0, 0, M1_HUMANOID | M1_TPORT,
        M2_HOSTILE | M2_FEMALE | M2_COLLECT, M3_INFRAVISIBLE | M3_PLACEHOLDER, CLR_GREEN),
    ...
    MON("orc", S_ORC, LVL(1, 9, 10, 0, -3), (G_GENO | G_NOGEN | G_LGROUP),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_PLACEHOLDER, CLR_RED),
    ...
    MON("leocrotta", S_QUADRUPED, LVL(6, 18, 4, 10, 0), (G_GENO | 2),
        ...
        M3_INFRAVISIBLE | M3_SUMMONABLE, CLR_RED),
    MON("earthshark", S_QUADRUPED, LVL(7, 12, 2, 0, 0), (G_GENO | 2),
        ...
        M2_HOSTILE | M2_STRONG, M3_JUMPER, CLR_GRAY),
    ...
    MON("manticore", S_QUADRUPED, LVL(10, 12, 3, 10, 0), (G_GENO | 2),
        ...
        M2_HOSTILE | M2_STRONG, M3_INFRAVISIBLE | M3_SUMMONABLE, CLR_YELLOW),
    ...
    MON("baluchitherium", S_QUADRUPED, LVL(14, 12, 5, 0, 0), (G_GENO | 2),
        ...
        M1_ANIMAL | M1_THICK_HIDE | M1_NOHANDS | M1_HERBIVORE,
        M2_HOSTILE | M2_STRONG, M3_INFRAVISIBLE | M3_SUMMONABLE, CLR_GRAY),
    MON("hellbear", S_QUADRUPED, LVL(16, 13, 5, 0, -1),
        ...
        M2_HOSTILE | M2_STRONG, M3_INFRAVISIBLE | M3_FLAMING, CLR_RED),
    ...
    MON("cave spider", S_SPIDER, LVL(1, 12, 3, 0, 0), (G_GENO | G_SGROUP | 2),
        ...
        M2_HOSTILE, M3_WEBMAKER, CLR_GRAY),
    ...
    MON("giant spider", S_SPIDER, LVL(5, 15, 4, 0, 0), (G_GENO | 1),
        ...
        SIZ(100, 100, MS_SILENT, MZ_LARGE), MR_POISON, MR_POISON,
        M1_ANIMAL | M1_NOHANDS | M1_OVIPAROUS | M1_POIS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG, M3_WEBMAKER, CLR_MAGENTA),
    ...
    MON("jumping spider", S_SPIDER, LVL(6, 15, 4, 0, 0), (G_GENO | 1),
        ...
        M1_ANIMAL | M1_NOHANDS | M1_OVIPAROUS | M1_POIS | M1_CARNIVORE
            | M1_CONCEAL,
        M2_HOSTILE | M2_STRONG, M3_JUMPER | M3_WEBMAKER, CLR_BLUE),
    MON("monstrous spider", S_SPIDER, LVL(8, 15, 4, 0, 0), (G_GENO | 1),
        ...
        M1_ANIMAL | M1_NOHANDS | M1_OVIPAROUS | M1_POIS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG, M3_WEBMAKER, CLR_ORANGE),
    /*
     * trappers, lurkers, &c
     */
    ...
    MON("trapper", S_TRAPPER, LVL(12, 3, 3, 0, 0), (G_GENO | 2),
        ...
        M1_HIDE | M1_ANIMAL | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD
            | M1_CARNIVORE,
        M2_HOSTILE | M2_STALK | M2_STRONG, M3_WIZAPP, CLR_GREEN),
    /*
     * unicorns and horses
     */
     ...
     * vortices
     */
    MON4("fog cloud", S_VORTEX, LVL(3, 1, 0, 0, 0), (G_GENO | G_NOCORPSE | 2),
        ...
        M2_HOSTILE | M2_NEUTER, 0, M4_VEGAN | M4_WHIRLY, CLR_GRAY),
    MON4("dust vortex", S_VORTEX, LVL(4, 20, 2, 30, 0),
        (G_GENO | G_NOCORPSE | 2), A(ATTK(AT_ENGL, AD_BLND, 2, 8), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(0, 0, MS_SILENT, MZ_HUGE), MR_SLEEP | MR_POISON | MR_STONE, 0,
        M1_FLY | M1_BREATHLESS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD
            | M1_MINDLESS,
        M2_HOSTILE | M2_NEUTER, 0, M4_VEGAN | M4_WHIRLY, CLR_BROWN),
    MON4("ice vortex", S_VORTEX, LVL(5, 20, 2, 30, 0),
        ...
        M1_FLY | M1_BREATHLESS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD
            | M1_MINDLESS,
        M2_HOSTILE | M2_NEUTER, M3_INFRAVISIBLE, M4_VEGAN| M4_WHIRLY, CLR_CYAN),
    MON4("energy vortex", S_VORTEX, LVL(6, 20, 2, 30, 0),
        (G_GENO | G_NOCORPSE | 1),
        ...
        M2_HOSTILE | M2_NEUTER, 0, M4_VEGAN | M4_WHIRLY, HI_ZAP),
    MON4("steam vortex", S_VORTEX, LVL(7, 22, 2, 30, 0),
        ...
        M1_FLY | M1_BREATHLESS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD
            | M1_MINDLESS | M1_UNSOLID,
        M2_HOSTILE | M2_NEUTER, M3_INFRAVISIBLE, M4_VEGAN | M4_WHIRLY, CLR_BLUE),
    MON4("fire vortex", S_VORTEX, LVL(8, 22, 2, 30, 0),
        ...
        M1_FLY | M1_BREATHLESS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD
            | M1_MINDLESS | M1_UNSOLID,
        M2_HOSTILE | M2_NEUTER, M3_INFRAVISIBLE | M3_FLAMING, M4_VEGAN | M4_WHIRLY, CLR_YELLOW),
    /*
     * worms
     */
    ...
    MON("baby long worm", S_WORM, LVL(5, 3, 5, 0, 0), G_GENO,
        ...
        M1_ANIMAL | M1_SLITHY | M1_NOLIMBS | M1_CARNIVORE | M1_NOTAKE,
        M2_HOSTILE, M3_LONGWORM, CLR_BROWN),
    ...
    MON("long worm", S_WORM, LVL(9, 3, 5, 10, 0), (G_GENO | 2),
        ...
        M1_ANIMAL | M1_SLITHY | M1_NOLIMBS | M1_OVIPAROUS | M1_CARNIVORE
            | M1_NOTAKE,
        M2_HOSTILE | M2_STRONG | M2_NASTY, M3_LONGWORM, CLR_BROWN),
    MON("purple worm", S_WORM, LVL(15, 9, 6, 20, 0), (G_GENO | 2),
        ...
        M1_ANIMAL | M1_SLITHY | M1_NOLIMBS | M1_OVIPAROUS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_NASTY, M3_SUMMONABLE, CLR_MAGENTA),
    /*
     * xan, &c
     */
    ...
    MON("xan", S_XAN, LVL(7, 18, -4, 0, 0), (G_GENO | 3),
        ...
        M3_INFRAVISIBLE | M3_SUMMONABLE | M3_WIZAPP, CLR_RED),
     ...
     * lights
     */
    MON4("will-o'-the-wisp", S_LIGHT, LVL(2, 9, 2, 0, 0),
        ...
        M2_HOSTILE | M2_NEUTER | M2_WANDER, M3_INFRAVISIBLE, M4_VEGAN, CLR_WHITE),
    MON4("yellow light", S_LIGHT, LVL(3, 15, 0, 0, 0),
        ...
        0, M1_FLY | M1_BREATHLESS | M1_AMORPHOUS | M1_NOEYES | M1_NOLIMBS
               | M1_NOHEAD | M1_MINDLESS | M1_UNSOLID | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER, M3_INFRAVISIBLE, M4_VEGAN, CLR_YELLOW),
    MON4("black light", S_LIGHT, LVL(5, 15, 0, 0, 0),
        ...
        M2_HOSTILE | M2_NEUTER, 0, M4_INVISIBLE | M4_VEGAN, CLR_BLACK),
    ...
    MON4("Tasmanian devil", S_ZOUTHERN, LVL(9, 12, 8, 0, 0),
      (G_NOHELL | G_GENO | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 2, 4),
          ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(500, 250, MS_GROWL, MZ_SMALL), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_OMNIVORE, M2_HOSTILE, M3_SUMMONABLE,
        M4_WHIRLY, CLR_BLACK),
    ...
    MON("wallaby", S_ZOUTHERN, LVL(5, 16, 7, 0, 0), (G_NOHELL | G_GENO | 1),
      ...
      M1_ANIMAL | M1_HERBIVORE, 0, M3_JUMPER, CLR_BROWN),
    ...
    MON("wallaroo", S_ZOUTHERN, LVL(6, 20, 8, 0, 0),
      ...
      M1_ANIMAL | M1_HERBIVORE, 0, M3_JUMPER, CLR_RED),
    /* nerfed damage output */
    MON("kangaroo", S_ZOUTHERN, LVL(10, 24, 6, 0, 0),
      ...
      M1_ANIMAL | M1_HERBIVORE, M2_NASTY, M3_JUMPER, CLR_GRAY),
    /*
    ...
    MON("couatl", S_ANGEL, LVL(8, 10, 5, 30, 7),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_SUMMONABLE, CLR_GREEN),
    MON("Aleax", S_ANGEL, LVL(10, 8, 0, 30, 7), (G_NOHELL | G_NOCORPSE | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_SUMMONABLE, CLR_YELLOW),
    ...
    MON("bat", S_BAT, LVL(0, 22, 8, 0, 0), (G_GENO | G_SGROUP | 1),
        ...
        M3_INFRAVISIBLE | M3_BAT, CLR_BROWN),
    MON("giant bat", S_BAT, LVL(2, 22, 7, 0, 0), (G_GENO | 2),
        A(ATTK(AT_BITE, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(30, 30, MS_SQEEK, MZ_SMALL), 0, 0,
        M1_FLY | M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE,
        M2_WANDER | M2_HOSTILE, M3_INFRAVISIBLE | M3_BAT, CLR_RED),
    ...
    MON("vampire bat", S_BAT, LVL(5, 20, 6, 0, 0), (G_GENO | 2),
        ...
        M2_HOSTILE, M3_INFRAVISIBLE | M3_BAT, CLR_BLACK),
     ...
     * Centaurs
     *
     * plain "centaur" for zombie corpses only; not created at random
     */
    MON("centaur", S_CENTAUR, LVL(4, 18, 4, 0, 0), (G_GENO | G_NOGEN),
        ...
        M3_INFRAVISIBLE | M3_PLACEHOLDER, CLR_BROWN),
    ...
    MON("hydra", S_DRAGON, LVL(20, 9, -2, 5, 7), (G_GENO | 1),
        ...
        MR_POISON | MR_STONE, MR_POISON,
       	...
       	0, CLR_BRIGHT_GREEN),
    MON("baby gray dragon", S_DRAGON, LVL(12, 9, 2, 10, 0), (G_NOHELL | G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1500, 500, MS_ROAR, MZ_HUGE), 0, 0,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS, M3_DRAGON, CLR_GRAY),
    MON("baby silver dragon", S_DRAGON, LVL(12, 9, 2, 10, 0), (G_NOHELL | G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1500, 500, MS_ROAR, MZ_HUGE), 0, 0,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS, M3_DRAGON, DRAGON_SILVER),
    MON("baby shimmering dragon", S_DRAGON,
        LVL(12, 9, 2, 10, 0), (G_NOHELL | G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1500, 500, MS_ROAR, MZ_HUGE), 0, 0,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS, M3_DRAGON | M3_DISPLACED, CLR_CYAN),
    MON("baby red dragon", S_DRAGON, LVL(12, 9, 2, 10, 0), (G_NOHELL | G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1500, 500, MS_ROAR, MZ_HUGE), MR_FIRE, 0,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS, M3_DRAGON | M3_INFRAVISIBLE,
        CLR_RED),
    MON("baby white dragon", S_DRAGON, LVL(12, 9, 2, 10, 0), (G_NOHELL | G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1500, 500, MS_ROAR, MZ_HUGE), MR_COLD, 0,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS, M3_DRAGON, CLR_WHITE),
    MON("baby orange dragon", S_DRAGON, LVL(12, 9, 2, 10, 0), (G_NOHELL | G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1500, 500, MS_ROAR, MZ_HUGE), MR_SLEEP, 0,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS, M3_DRAGON, CLR_ORANGE),
    MON("baby purple dragon", S_DRAGON, LVL(12, 9, 2, 10, 0), (G_NOHELL | G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1500, 500, MS_ROAR, MZ_HUGE), MR_SONIC, 0,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS, M3_DRAGON, CLR_BRIGHT_MAGENTA),
    MON("baby black dragon", S_DRAGON, LVL(12, 9, 2, 10, 0), (G_NOHELL | G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1500, 500, MS_ROAR, MZ_HUGE), MR_DISINT, 0,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS, M3_DRAGON, CLR_BLACK),
    MON("baby blue dragon", S_DRAGON, LVL(12, 9, 2, 10, 0), (G_NOHELL | G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1500, 500, MS_ROAR, MZ_HUGE), MR_ELEC, 0,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS, M3_DRAGON, CLR_BLUE),
    MON("baby green dragon", S_DRAGON, LVL(12, 9, 2, 10, 0), (G_NOHELL | G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1500, 500, MS_ROAR, MZ_HUGE), MR_POISON, 0,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE | M1_POIS,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS, M3_DRAGON, CLR_GREEN),
    MON("baby yellow dragon", S_DRAGON, LVL(12, 9, 2, 10, 0), (G_NOHELL | G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1500, 500, MS_ROAR, MZ_HUGE), MR_ACID | MR_STONE, 0,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE | M1_ACID,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS, M3_DRAGON, CLR_YELLOW),
    ...
    MON("silver dragon", S_DRAGON, LVL(15, 9, -1, 20, 4), (G_GENO | 1),
        ...
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_SEE_INVIS | M1_OVIPAROUS
            | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
         M3_SUMMONABLE | M3_DRAGON, DRAGON_SILVER),
    MON("shimmering dragon", S_DRAGON,
        ...
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_SEE_INVIS | M1_OVIPAROUS
          | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
        M3_DRAGON | M3_DISPLACED, CLR_CYAN),
    MON("red dragon", S_DRAGON, LVL(15, 9, -1, 20, -4), (G_GENO | 1),
        ...
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_SEE_INVIS | M1_OVIPAROUS
            | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
        M3_INFRAVISIBLE | M3_SUMMONABLE | M3_WIZAPP | M3_DRAGON, CLR_RED),
    ...
    MON("orange dragon", S_DRAGON, LVL(15, 9, -1, 20, 5), (G_GENO | 1),
        ...
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_SEE_INVIS | M1_OVIPAROUS
            | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
        M3_SUMMONABLE | M3_DRAGON, CLR_ORANGE),
    ...
    MON("black dragon", S_DRAGON, LVL(15, 9, -1, 20, -6), (G_GENO | 1),
        ...
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_SEE_INVIS | M1_OVIPAROUS
            | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
        M3_SUMMONABLE | M3_DRAGON, CLR_BLACK),
    ...
    MON("green dragon", S_DRAGON, LVL(15, 9, -1, 20, 6), (G_GENO | 1),
        ...
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
        M3_SUMMONABLE | M3_DRAGON, CLR_GREEN),
    ...
    MON("ooze dragon", S_DRAGON, LVL(25, 9, -10, 20, -7), (G_GENO | 1),
        ...
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
        M3_DRAGON | M3_ELDER, CLR_BRIGHT_GREEN),
    ...
    MON("hex dragon", S_DRAGON, LVL(25, 9, -10, 80, -6), (G_GENO | 1),
        ...
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
        M3_DRAGON | M3_ELDER, CLR_BRIGHT_BLUE),
    ...
    MON("yellow dragon", S_DRAGON, LVL(15, 9, -1, 20, 7), (G_GENO | 1),
        ...
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
        M3_SUMMONABLE | M3_DRAGON | M3_ELDER, CLR_YELLOW),
    /*
     * Elementals
     */
    MON("stalker", S_ELEMENTAL, LVL(8, 12, 3, 0, 0), (G_GENO | 3),
        ...
        M2_WANDER | M2_STALK | M2_HOSTILE | M2_STRONG, M3_INFRAVISION | M3_SUMMONABLE,
        CLR_WHITE),
    MON4("air elemental", S_ELEMENTAL, LVL(8, 36, 2, 30, 0), (G_NOCORPSE | 1),
        ...
        M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS | M1_BREATHLESS
            | M1_UNSOLID | M1_FLY,
        M2_STRONG | M2_NEUTER, 0, M4_VEGAN | M4_WHIRLY, CLR_CYAN),
    MON4("storm elemental", S_ELEMENTAL, LVL(8, 12, 2, 30, 0), (G_NOCORPSE | 1),
        ...
        M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS | M1_BREATHLESS
            | M1_UNSOLID | M1_FLY,
        M2_STRONG | M2_NEUTER, 0, M4_VEGAN, CLR_GRAY),
    MON4("fire elemental", S_ELEMENTAL, LVL(8, 12, 2, 30, 0), (G_NOCORPSE | 1),
        ...
        M2_STRONG | M2_NEUTER, M3_INFRAVISIBLE | M3_SUMMONABLE | M3_FLAMING, M4_VEGAN, CLR_YELLOW),
    MON4("magma elemental", S_ELEMENTAL, LVL(8, 6, 2, 30, 0), (G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_FIRE, 4, 5), ATTK(AT_NONE, AD_FIRE, 0, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(0, 0, MS_SILENT, MZ_HUGE), MR_FIRE, 0,
        M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS | M1_BREATHLESS
            | M1_THICK_HIDE | M1_NOTAKE,
        M2_STRONG | M2_NEUTER, M3_INFRAVISIBLE | M3_FLAMING, M4_VEGAN, CLR_ORANGE),
    MON4("earth elemental", S_ELEMENTAL, LVL(8, 6, 2, 30, 0), (G_NOCORPSE | 1),
        ...
        M2_STRONG | M2_NEUTER, 0, M4_VEGAN, CLR_BROWN),
    MON4("water elemental", S_ELEMENTAL, LVL(8, 6, 2, 30, 0), (G_NOCORPSE | 1),
        ...
        M2_STRONG | M2_NEUTER, 0, M4_VEGAN, CLR_BLUE),
    MON4("fusion elemental", S_ELEMENTAL, LVL(25, 18, 2, 30, 0),
        (G_NOCORPSE | G_GENO | 1),
        ...
        M2_STRONG | M2_NEUTER, 0, M4_VEGAN, CLR_MAGENTA),
    /*
     * Fungi
     */
    MON4("lichen", S_FUNGUS, LVL(0, 1, 9, 0, 0), (G_GENO | 4),
        ...
        M1_BREATHLESS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER, M3_NONROTTING, M4_VEGAN, CLR_BRIGHT_GREEN),
    MON4("brown mold", S_FUNGUS, LVL(1, 0, 9, 0, 0), (G_GENO | 1),
        A(ATTK(AT_NONE, AD_COLD, 0, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        ...
        M2_HOSTILE | M2_NEUTER, 0, M4_VEGAN, CLR_BROWN),
    MON4("yellow mold", S_FUNGUS, LVL(1, 0, 9, 0, 0), (G_GENO | 2),
        A(ATTK(AT_NONE, AD_STUN, 0, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(50, 30, MS_SILENT, MZ_SMALL), MR_POISON, MR_POISON,
        M1_BREATHLESS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_POIS | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER, 0, M4_VEGAN, CLR_YELLOW),
    MON4("volatile mushroom", S_FUNGUS, LVL(1, 0, 9, 0, 0),
        (G_GENO | G_LGROUP | G_NOCORPSE | 1),
        A(ATTK(AT_BOOM, AD_PHYS, 4, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(50, 30, MS_SILENT, MZ_SMALL), MR_POISON, MR_POISON,
        M1_BREATHLESS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_POIS | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER, 0, M4_VEGAN, CLR_ORANGE),
    MON4("green mold", S_FUNGUS, LVL(1, 0, 9, 0, 0), (G_GENO | 1),
        ...
        M1_BREATHLESS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_ACID | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER, 0, M4_VEGAN, CLR_GREEN),
    MON4("red mold", S_FUNGUS, LVL(1, 0, 9, 0, 0), (G_GENO | 1),
        ...
        MR_FIRE | MR_POISON, M1_BREATHLESS | M1_NOEYES | M1_NOLIMBS
                                 | M1_NOHEAD | M1_MINDLESS | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER, M3_INFRAVISIBLE, M4_VEGAN, CLR_RED),
    MON4("shrieker", S_FUNGUS, LVL(3, 1, 7, 0, 0), (G_GENO | 1),
        A(NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(100, 100, MS_SHRIEK, MZ_SMALL), MR_POISON, MR_POISON,
        M1_BREATHLESS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER, 0, M4_VEGAN, CLR_MAGENTA),
    MON4("violet fungus", S_FUNGUS, LVL(3, 1, 7, 0, 0), (G_GENO | 2),
        ...
        M1_BREATHLESS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER, 0, M4_VEGAN, CLR_MAGENTA),
    MON4("legendary lichen", S_FUNGUS, LVL(4, 3, 9, 0, 0), (G_GENO | 2),
        A(ATTK(AT_TUCH, AD_PHYS, 2, 4), ATTK(AT_TUCH, AD_STCK, 0, 0),
            NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(20, 200, MS_SILENT, MZ_SMALL), 0, 0,
        M1_BREATHLESS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER | M2_LORD, M3_NONROTTING, M4_VEGAN, HI_LORD),
    MON4("screamer", S_FUNGUS, LVL(4, 4, 7, 0, 0), (G_GENO | 1),
        A(ATTK(AT_TUCH, AD_LOUD, 3, 3),
        NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(100, 100, MS_SHRIEK, MZ_SMALL), MR_POISON | MR_SONIC, 0,
        M1_BREATHLESS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER, 0, M4_VEGAN, CLR_BRIGHT_MAGENTA),
    MON4("brown mold warrior", S_FUNGUS, LVL(5, 12, 8, 0, 0),
        (G_GENO | 1),
        ...
        M2_STALK | M2_NEUTER | M2_HOSTILE, M3_INFRAVISION, M4_VEGAN, CLR_BROWN),
    MON4("yellow mold warrior", S_FUNGUS, LVL(5, 12, 8, 0, 0),
        (G_GENO | 1),
        ...
        M1_BREATHLESS | M1_HUMANOID | M1_NOEYES,
        M2_STALK | M2_NEUTER | M2_HOSTILE, M3_INFRAVISION, M4_VEGAN, CLR_YELLOW),
    MON4("green mold warrior", S_FUNGUS, LVL(5, 12, 8, 0, 0),
        (G_GENO | 1),
        ...
        M1_BREATHLESS | M1_HUMANOID | M1_NOEYES,
        M2_STALK | M2_NEUTER | M2_HOSTILE, M3_INFRAVISION, M4_VEGAN, CLR_GREEN),
    MON4("red mold warrior", S_FUNGUS, LVL(5, 12, 8, 0, 0),
        (G_GENO | 1),
        ...
        M1_BREATHLESS | M1_HUMANOID | M1_NOEYES,
        M2_STALK | M2_NEUTER | M2_HOSTILE, M3_INFRAVISION, M4_VEGAN, CLR_RED),
    /*
     * Gnomes
     */
    ...
    MON("anubite", S_GNOLL,
      	...
      	M3_INFRAVISION | M3_JUMPER, CLR_BLACK),
    MON("gnoll", S_GNOLL,
...
struct permonst _mons2[] = {
    ...
    MON("ettin", S_GIANT, LVL(10, 12, 3, 0, 0), (G_GENO | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_SUMMONABLE, CLR_BROWN),
    MON("storm giant", S_GIANT, LVL(16, 12, 3, 10, -3),
        ...
        M1_HUMANOID | M1_CARNIVORE, M2_GIANT | M2_STRONG | M2_ROCKTHROW
                                        | M2_NASTY | M2_COLLECT | M2_JEWELS,
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_SUMMONABLE, CLR_BLUE),
    ...
    MON("minotaur", S_GIANT, LVL(15, 15, 6, 0, 0), (G_GENO | G_NOGEN),
        ...
        M1_ANIMAL | M1_HUMANOID | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_NASTY, M3_INFRAVISIBLE | M3_INFRAVISION | M3_SUMMONABLE,
        CLR_BROWN),
    ...
    MON("jabberwock", S_JABBERWOCK, LVL(15, 12, -2, 50, 0), (G_GENO | 1),
        ...
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_COLLECT, M3_INFRAVISIBLE | M3_SUMMONABLE,
        CLR_ORANGE),
    ...
    MON("arch-lich", S_LICH, LVL(25, 9, -6, 90, -15),
        ...
        M1_BREATHLESS | M1_HUMANOID | M1_POIS | M1_REGEN,
        M2_UNDEAD | M2_HOSTILE | M2_MAGIC, M3_WANTSBOOK | M3_INFRAVISION | M3_SUMMONABLE,
        HI_LORD),
    ...
    MON("guardian naga", S_NAGA, LVL(12, 16, 0, 50, 7), (G_GENO | 1),
        ...
        M2_STRONG, M3_SUMMONABLE | M3_WIZAPP, CLR_GREEN),
    /*
     * Ogres
     */
    ...
    MON("ogre king", S_OGRE, LVL(9, 14, 4, 60, -7), (G_GENO | 2),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_SUMMONABLE, HI_LORD),
    /*
     *
     * Fantastical plants
     *
    ...
    MON("walking oak", S_PLANT, LVL(7, 3, 2, 40, 7),
        ...
        M1_BREATHLESS | M1_HUMANOID | M1_THICK_HIDE, M2_STRONG, M3_FLAMMABLE, HI_WOOD),
    MON("walking birch", S_PLANT, LVL(9, 5, 0, 20, -3),
        (G_NOCORPSE | G_GENO | G_SGROUP | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 4, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1200, 0, MS_HUMANOID, MZ_LARGE), MR_COLD, 0,
        M1_BREATHLESS | M1_HUMANOID | M1_THICK_HIDE, M2_STRONG, M3_FLAMMABLE, CLR_WHITE),
    MON("walking willow", S_PLANT, LVL(14, 7, -2, 60, 0),
        (G_NOCORPSE | G_GENO | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 5, 4), ATTK(AT_TUCH, AD_WIND, 3, 3), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1200, 0, MS_HUMANOID, MZ_LARGE), MR_COLD, 0,
        M1_BREATHLESS | M1_HUMANOID | M1_THICK_HIDE, M2_STRONG, M3_FLAMMABLE, CLR_BLACK),
     ...
     */
    MON4("gray ooze", S_PUDDING, LVL(3, 1, 8, 0, 0), (G_GENO | G_NOCORPSE | 2),
        ...
        M2_HOSTILE | M2_NEUTER, 0, M4_VEGETARIAN, CLR_GRAY),
    MON4("brown pudding", S_PUDDING, LVL(5, 3, 8, 0, 0),
        ...
        M1_BREATHLESS | M1_AMORPHOUS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD
            | M1_MINDLESS | M1_OMNIVORE | M1_ACID,
        M2_HOSTILE | M2_NEUTER, 0, M4_VEGETARIAN, CLR_BROWN),
    MON4("green slime", S_PUDDING, LVL(6, 6, 6, 0, 0),
        (G_HELL | G_GENO | G_NOCORPSE | 1),
        ...
        M2_HOSTILE | M2_NEUTER, M3_SUMMONABLE | M3_FLAMMABLE | M3_SLIME,
        M4_VEGETARIAN, CLR_GREEN),
    ...
    MON("Ancient Brain", S_PUDDING, LVL(15, 12, 10, 50, 13), (G_UNIQ | G_NOGEN),
      A(ATTK(AT_MAGC, AD_PSYC, 2, 4), ATTK(AT_MAGC, AD_PSYC, 2, 4),
        ...
        M2_HOSTILE | M2_NEUTER, M3_TELEPATHIC | M3_MINDFLAYER, HI_LORD),
    MON4("colossal slime", S_PUDDING, LVL(18, 9, 6, 0, 0),
        (G_HELL | G_GENO | G_NOCORPSE | 1),
        ...
        M1_BREATHLESS | M1_AMORPHOUS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD
            | M1_MINDLESS | M1_OMNIVORE | M1_ACID | M1_POIS,
        M2_HOSTILE | M2_NEUTER, M3_FLAMMABLE | M3_SLIME, M4_VEGETARIAN, CLR_BRIGHT_GREEN),
    /*
     * Strange beings
     */
    ...
    MON("amalgamation", S_QUANTMECH, LVL(10, 6, 5, 10, 0),
        ...
        M2_HOSTILE | M2_NOPOLY, M3_SUMMONABLE, CLR_WHITE),
    ...
    MON("disenchanter", S_RUSTMONST, LVL(12, 12, -10, 0, -3),
        ...
        M2_HOSTILE, M3_INFRAVISIBLE | M3_SUMMONABLE, CLR_BLUE),
    /*
     * Snakes
     */
    ...
    MON4("troll", S_TROLL, LVL(7, 12, 4, 0, -3), (G_GENO | 2),
        ...
        M2_STRONG | M2_STALK | M2_HOSTILE, M3_INFRAVISIBLE | M3_INFRAVISION | M3_WIZAPP,
        M4_REVIVE, CLR_BROWN),
    ...
    MON4("rock troll", S_TROLL, LVL(9, 12, 0, 0, -3), (G_GENO | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, M4_REVIVE, CLR_CYAN),
    MON4("water troll", S_TROLL, LVL(11, 14, 4, 40, -3), (G_GENO),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 8), ATTK(AT_CLAW, AD_PHYS, 2, 8),
          ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON4("Olog-hai", S_TROLL, LVL(13, 12, -4, 0, -7), (G_GENO | 1),
        ...
        M1_HUMANOID | M1_REGEN | M1_CARNIVORE,
        M2_STRONG | M2_STALK | M2_HOSTILE | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_SUMMONABLE, M4_REVIVE, HI_LORD),
    /*
     * Umber hulk
     */
    MON("umber hulk", S_UMBER, LVL(9, 6, 2, 25, 0), (G_GENO | 2),
        ...
        M2_STRONG, M3_INFRAVISIBLE | M3_SUMMONABLE | M3_WIZAPP, CLR_BROWN),
    ...
    MON("banshee", S_WRAITH, LVL(15, 10, 10, 0, 5), (G_GENO | G_NOCORPSE | 1),
        ...
        M3_INFRAVISION | M3_SUMMONABLE, CLR_CYAN),
    /*
     * Xorn
     */
    MON("xorn", S_XORN, LVL(8, 9, -2, 20, 0), (G_GENO | 1),
        ...
        M2_HOSTILE | M2_STRONG, M3_SUMMONABLE | M3_WIZAPP, CLR_BROWN),
    /*
     * Apelike beasts
     */
    ...
    MON("owlbear", S_YETI, LVL(5, 12, 5, 0, 0), (G_GENO | 3),
        ...
        M1_ANIMAL | M1_HUMANOID | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_NASTY, M3_INFRAVISIBLE | M3_SUMMONABLE, CLR_BROWN),
    ...
    MON("carnivorous ape", S_YETI, LVL(6, 12, 6, 0, 0), (G_GENO | 1),
        ...
        M1_ANIMAL | M1_HUMANOID | M1_CARNIVORE, M2_HOSTILE | M2_STRONG,
        M3_INFRAVISIBLE | M3_SUMMONABLE, CLR_BLACK),
    ...
    MON("zruty", S_YETI, LVL(9, 8, 3, 0, 0), (G_GENO | 2),
        ...
        M1_ANIMAL | M1_HUMANOID | M1_CARNIVORE, M2_HOSTILE | M2_STRONG,
        M3_INFRAVISIBLE | M3_SUMMONABLE, CLR_GREEN),
    /*
     * Zombies
#define LVL(lvl, mov, ac, mr, aln) lvl, mov, ac, mr, aln
     */
    MON("kobold zombie", S_ZOMBIE, LVL(0, 6, 10, 0, -2),
        (G_GENO | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_ZOMB, 1, 4), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(400, 50, MS_GROAN, MZ_SMALL), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_UNDEAD | M2_STALK | M2_HOSTILE, M3_INFRAVISION, CLR_BROWN),
    MON("goblin zombie", S_ZOMBIE, LVL(0, 6, 10, 0, -2),
        (G_GENO | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_ZOMB, 1, 4), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(400, 100, MS_GROAN, MZ_SMALL), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS, 
        M2_UNDEAD | M2_STALK | M2_HOSTILE | M2_ORC, M3_INFRAVISION,
        CLR_GRAY),
    MON("gnome zombie", S_ZOMBIE, LVL(1, 6, 10, 0, -2),
        (G_GENO | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_ZOMB, 1, 5), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(650, 50, MS_GROAN, MZ_SMALL), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_UNDEAD | M2_STALK | M2_HOSTILE | M2_GNOME, M3_INFRAVISION,
        CLR_BROWN),
    MON("hobgoblin zombie", S_ZOMBIE, LVL(1, 5, 10, 0, -2),
        (G_GENO | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_ZOMB, 1, 6), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1000, 200, MS_GROAN, MZ_HUMAN), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_UNDEAD | M2_STALK | M2_HOSTILE | M2_ORC, M3_INFRAVISION,
        CLR_GRAY),
    MON("ratman zombie", S_ZOMBIE, LVL(2, 6, 8, 0, -3), (G_GENO | G_LGROUP | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_ZOMB, 1, 2), ATTK(AT_BITE, AD_PHYS, 1, 1),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(800, 100, MS_GROAN, MZ_HUMAN), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_SWIM,
        M2_UNDEAD | M2_STALK | M2_HOSTILE,
        M3_INFRAVISION, CLR_GREEN),
    MON("hobbit zombie", S_ZOMBIE, LVL(2, 6, 10, 0, -2),
        (G_GENO | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_ZOMB, 1, 6), NO_ATTK,
            NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(500, 200, MS_GROAN, MZ_SMALL), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_UNDEAD | M2_STALK | M2_HOSTILE, M3_INFRAVISION, CLR_GREEN),
    MON("orc zombie", S_ZOMBIE, LVL(2, 6, 9, 0, -3),
        (G_GENO | G_SGROUP | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_ZOMB, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("dwarf zombie", S_ZOMBIE, LVL(2, 6, 9, 0, -3),
        ...
        CLR_RED),
    MON("nymph zombie", S_ZOMBIE, LVL(3, 6, 9, 20, 0), (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_ZOMB, 1, 2), ATTK(AT_CLAW, AD_PHYS, 1, 2), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(600, 300, MS_GROAN, MZ_HUMAN), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_TPORT,
        M2_UNDEAD | M2_STALK | M2_HOSTILE | M2_FEMALE, M3_INFRAVISION,
        CLR_BRIGHT_GREEN),
    MON("elf zombie", S_ZOMBIE, LVL(3, 6, 9, 0, -3),
        (G_GENO | G_SGROUP | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_ZOMB, 1, 7), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        ...
        CLR_GREEN),
    MON("bugbear zombie", S_ZOMBIE, LVL(4, 6, 5, 0, -6),
        (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_ZOMB, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1250, 250, MS_GROAN, MZ_LARGE), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID,
        M2_UNDEAD | M2_STALK | M2_HOSTILE, M3_INFRAVISION,
        CLR_BROWN),
    MON("human zombie", S_ZOMBIE, LVL(4, 6, 8, 0, -3),
        (G_GENO | G_SGROUP | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_ZOMB, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("ogre zombie", S_ZOMBIE, LVL(5, 6, 5, 0, -3), (G_GENO | G_SGROUP | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_ZOMB, 2, 5), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1600, 500, MS_GRUNT, MZ_LARGE), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID,
        M2_UNDEAD | M2_STALK | M2_HOSTILE | M2_STRONG,
        M3_INFRAVISION, CLR_BROWN),
    MON("centaur zombie", S_ZOMBIE, LVL(6, 10, 4, 0, -2), (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_ZOMB, 1, 6), ATTK(AT_KICK, AD_PHYS, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2500, 500, MS_HUMANOID, MZ_LARGE), 0, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID,
        M2_UNDEAD | M2_STALK | M2_HOSTILE,
    ...
    MON("ettin zombie", S_ZOMBIE, LVL(6, 8, 6, 0, -4),
        (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_ZOMB, 1, 10), ATTK(AT_CLAW, AD_PHYS, 1, 10),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1700, 250, MS_GROAN, MZ_HUGE), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID,
        M2_UNDEAD | M2_STALK | M2_HOSTILE | M2_STRONG, M3_INFRAVISION,
        CLR_BLUE),   
    MON("mind flayer zombie", S_ZOMBIE, LVL(7, 8, 5, 90, -8), (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_ZOMB, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
          ATTK(AT_TENT, AD_DRIN, 2, 1), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1450, 400, MS_HISS, MZ_HUMAN), MR_PSYCHIC, 0,
        M1_HUMANOID | M1_FLY | M1_SEE_INVIS | M1_BREATHLESS | M1_MINDLESS,
        M2_UNDEAD | M2_STALK | M2_HOSTILE | M2_NASTY,
        M3_INFRAVISION | M3_TELEPATHIC | M3_MINDFLAYER, CLR_MAGENTA),
    MON("ghoul", S_ZOMBIE, LVL(3, 6, 10, 0, -2), (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PLYS, 1, 2), ATTK(AT_CLAW, AD_ZOMB, 1, 3), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(400, 50, MS_SILENT, MZ_SMALL), MR_COLD | MR_SLEEP | MR_POISON, 0,
    ...
    MON("skeletal pirate", S_ZOMBIE, LVL(5, 8, 4, 0, 0),
        ...
        M2_UNDEAD | M2_WANDER | M2_HOSTILE | M2_STRONG | M2_COLLECT | M2_NASTY,
      	M3_INFRAVISION | M3_PIRATE, CLR_WHITE),
    MON("troll zombie", S_ZOMBIE, LVL(7, 6, 4, 0, -3), (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 4, 2), ATTK(AT_CLAW, AD_ZOMB, 4, 2),
          ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(800, 350, MS_GRUNT, MZ_LARGE), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_REGEN,
        M2_UNDEAD | M2_STALK | M2_HOSTILE | M2_STRONG, M3_INFRAVISION,
        CLR_BROWN),
    MON("giant zombie", S_ZOMBIE, LVL(8, 8, 6, 0, -4),
        (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_ZOMB, 2, 8), ATTK(AT_CLAW, AD_PHYS, 2, 8), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("zombie dragon", S_ZOMBIE, LVL(14, 8, -1, 20, -4), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 3, 8), ATTK(AT_CLAW, AD_ZOMB, 1, 4),
          ATTK(AT_CLAW, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("gnoll zombie", S_GNOME,
      	LVL(18, 8, 5, 10, -5), (G_GENO | G_HELL | G_NOCORPSE | 1),
      	A(ATTK(AT_WEAP, AD_PHYS, 3, 6),  ATTK(AT_CLAW, AD_ZOMB, 3, 6),
      	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
      	SIZ(1800, 100, MS_ORC, MZ_LARGE), 0, 0,
      	M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS | M1_SEE_INVIS,
      	M2_UNDEAD | M2_STALK | M2_HOSTILE | M2_NOPOLY,
    ...
    MON("straw golem", S_GOLEM, LVL(3, 12, 10, 0, 0), (G_NOCORPSE | 1),
        ...
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID, M2_HOSTILE | M2_NEUTER, M3_FLAMMABLE,
        CLR_YELLOW),
    ...
    MON("wax golem", S_GOLEM, LVL(3, 12, 9, 0, 0), (G_NOCORPSE | 1),
        ...
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID,
        M2_HOSTILE | M2_NEUTER, M3_INFRAVISIBLE | M3_FLAMING, CLR_GRAY),
    ...
    MON4("leather golem", S_GOLEM, LVL(6, 6, 6, 0, 0), (G_NOCORPSE | 1),
    ...
    MON("wood golem", S_GOLEM, LVL(7, 3, 4, 0, 0), (G_NOCORPSE | 1),
        ...
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_THICK_HIDE,
        M2_HOSTILE | M2_NEUTER, M3_FLAMMABLE, HI_WOOD),
    MON4("flesh golem", S_GOLEM, LVL(9, 8, 9, 30, 0), (1),
        ...
        MR_FIRE | MR_COLD | MR_ELEC | MR_SLEEP | MR_POISON,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID, M2_HOSTILE | M2_STRONG, 0, M4_VEGAN,
        CLR_RED),
    ...
    MON("iron golem", S_GOLEM, LVL(18, 6, 3, 60, 0), (G_NOCORPSE | 1),
        ...
        M2_HOSTILE | M2_STRONG | M2_COLLECT, M3_SUMMONABLE, HI_METAL),
    /*
    ...
    MON("human", S_HUMAN, LVL(0, 12, 10, 0, 0), G_NOGEN, /* for corpses */
        ...
        M2_NOPOLY | M2_HUMAN | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE | M3_PLACEHOLDER,
        HI_DOMESTIC),
    ...
    MON("elf", S_HUMAN, LVL(10, 12, 10, 2, -3), G_NOGEN, /* for corpses */
        ...
        M3_INFRAVISION | M3_INFRAVISIBLE | M3_PLACEHOLDER, HI_DOMESTIC),
    ...
    MON("elf-lord", S_HUMAN, LVL(8, 12, 10, 20, -9), (G_GENO | G_SGROUP | 2),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_SUMMONABLE, CLR_BRIGHT_BLUE),
    ...
    MON("captain", S_HUMAN, LVL(12, 10, 10, 15, -5), (G_GENO | 1),
        ...
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_HUMAN | M2_MERC | M2_STALK
                                       | M2_HOSTILE | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE | M3_SUMMONABLE, CLR_BLUE),
    ...
    MON("watchman", S_HUMAN, LVL(6, 10, 10, 0, -2),
        ...
        M3_INFRAVISIBLE | M3_WATCH, CLR_GRAY),
    MON("watch captain", S_HUMAN, LVL(10, 10, 10, 15, -4),
        ...
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_HUMAN | M2_MERC | M2_STALK
                                       | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE | M3_WATCH, CLR_GREEN),
    ...
    MON("water demon", S_DEMON, LVL(8, 12, -4, 30, -7),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_WIZAPP, CLR_BLUE),
...
#define SEDUCTION_ATTACKS_NO                                      \
    ...
    MON("nuckelavee", S_DEMON, LVL(11, 18, -3, 50, -12),
      ...
      M3_INFRAVISIBLE | M3_INFRAVISION | M3_SUMMONABLE, CLR_BRIGHT_GREEN),
    ...
    MON4("Death", S_DEMON, LVL(30, 12, -5, 100, 0), (G_UNIQ | G_NOGEN),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_DISPLACES | M3_RIDER | M3_NONROTTING, M4_REVIVE, HI_LORD),
    ...
    MON("lizard", S_LIZARD, LVL(5, 6, 6, 10, 0), (G_GENO | 5),
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_NONROTTING, CLR_GREEN),
    ...
    MON("salamander", S_LIZARD, LVL(8, 12, -1, 0, -9), (G_HELL | 1),
        ...
        M2_STALK | M2_HOSTILE | M2_COLLECT | M2_MAGIC, M3_INFRAVISIBLE | M3_FLAMING,
        CLR_ORANGE),
    ...
    MON("long worm tail", S_WORM_TAIL, LVL(0, 0, 0, 0, 0),
        (G_NOGEN | G_NOCORPSE | G_UNIQ),
        A(NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(0, 0, 0, 0), 0, 0, 0L, M2_NOPOLY, M3_LONGWORM, CLR_BROWN),
    /* Note:
    ...
    MON("archeologist", S_HUMAN, LVL(10, 12, 10, 1, 3), G_NOGEN,
        ...
        M2_NOPOLY | M2_HUMAN | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE | M3_MPLAYER,
        HI_DOMESTIC),
    ...
    MON("cartomancer", S_HUMAN, LVL(10, 12, 10, 3, 0), G_NOGEN,
        ...
        M3_INFRAVISIBLE | M3_MPLAYER, HI_DOMESTIC),
    ...
    MON("pirate", S_HUMAN, LVL(10, 12, 10, 1, -3), G_NOGEN,
        ...
        M3_INFRAVISIBLE | M3_MPLAYER | M3_PIRATE,
       	HI_DOMESTIC),
    ...
    MON("King Arthur", S_HUMAN, LVL(20, 12, 0, 40, 20), (G_NOGEN | G_UNIQ),
        ...
        M2_NOPOLY | M2_HUMAN | M2_PNAME | M2_PEACEFUL | M2_STRONG | M2_MALE
            | M2_COLLECT | M2_MAGIC,
        M3_CLOSE | M3_INFRAVISIBLE, HI_LORD),
    MON("Drakemother", S_DRAGON, LVL(25, 18, -1, 20, -4), (G_NOGEN | G_UNIQ | 1),
        A(ATTK(AT_BREA, AD_FIRE, 6, 6), ATTK(AT_BITE, AD_PHYS, 3, 8),
          ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4), NO_ATTK,
          NO_ATTK),
    ...
    MON("Mayor Cummerbund", S_HUMAN, LVL(20, 12, 0, 70, 0), (G_NOGEN | G_UNIQ),
        ...
        M3_CLOSE | M3_INFRAVISIBLE | M3_PIRATE, HI_LORD),
    ...
    MON("Cyclops", S_GIANT, LVL(18, 12, 0, 0, -15), (G_NOGEN | G_UNIQ),
        ...
        M3_WANTSARTI | M3_WAITFORU | M3_INFRAVISION | M3_INFRAVISIBLE | M3_ONEEYE,
        CLR_GRAY),
    ...
    MON("pirate brother", S_HUMAN, LVL(5, 12, 10, 10, -3), G_NOGEN,
       	...
       	M3_INFRAVISIBLE | M3_PIRATE, HI_DOMESTIC),
    ...
    MON("Vlad the Impaler", S_HUMAN, LVL(28, 26, -6, 80, -10),
        (G_NOGEN | G_NOCORPSE | G_UNIQ),
