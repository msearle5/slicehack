...
NEARDATA struct permonst mons[] = {
    ...
    MON("super-bat", S_BAT, LVL(7, 22, 7, 0, 0), (G_GENO | 2),
        A(ATTK(AT_BITE, AD_PHYS, 1, 4), ATTK(AT_CARY, AD_PHYS, 1, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK), SIZ(500, 250, MS_SQEEK, MZ_LARGE),
      0, 0, M1_FLY | M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE,
        M2_WANDER | M2_HOSTILE, M3_INFRAVISIBLE | M3_BAT, CLR_BRIGHT_BLUE),
...
struct permonst _mons2[] = {
    ...
    MON("frost giant", S_GIANT, LVL(10, 12, 3, 10, -3),
        ...
        M1_HUMANOID | M1_CARNIVORE, M2_GIANT | M2_STRONG | M2_ROCKTHROW
                                        | M2_NASTY | M2_COLLECT | M2_JEWELS,
        M3_INFRAVISIBLE | M3_INFRAVISION, CLR_WHITE),
    MON4("ettin", S_GIANT, LVL(10, 12, 3, 0, 0), (G_GENO | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_SUMMONABLE, M4_TWOHEADED, CLR_BROWN),
