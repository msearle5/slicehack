...
NEARDATA struct permonst mons[] = {
    ...
    MON("chickatrice", S_COCKATRICE, LVL(4, 4, 8, 30, 0),
        ...
        M2_HOSTILE, M3_INFRAVISIBLE | M3_SUMMONABLE | M3_WIZAPP, CLR_BROWN),
    ...
    MON("ochre jelly", S_JELLY, LVL(6, 3, 8, 20, 0), (G_GENO | 2),
        ...
        M1_BREATHLESS | M1_AMORPHOUS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD
            | M1_MINDLESS | M1_ACID | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER, M3_SUMMONABLE, CLR_BROWN),
    /*
     * kobolds
     */
    ...
    MON("fire vortex", S_VORTEX, LVL(8, 22, 2, 30, 0),
        ...
        M1_FLY | M1_BREATHLESS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD
            | M1_MINDLESS | M1_UNSOLID,
        M2_HOSTILE | M2_NEUTER, M3_INFRAVISIBLE | M3_FLAMING, CLR_YELLOW),
    /*
     * worms
     */
    ...
    MON("Tasmanian devil", S_ZOUTHERN, LVL(9, 12, 8, 0, 0),
      (G_NOHELL | G_GENO | 1),
    	...
    	M1_ANIMAL | M1_NOHANDS | M1_OMNIVORE, M2_HOSTILE, M3_SUMMONABLE, CLR_BLACK),
    ...
    MON("fire elemental", S_ELEMENTAL, LVL(8, 12, 2, 30, 0), (G_NOCORPSE | 1),
        ...
        M2_STRONG | M2_NEUTER, M3_INFRAVISIBLE | M3_SUMMONABLE | M3_FLAMING, CLR_YELLOW),
    MON("magma elemental", S_ELEMENTAL, LVL(8, 6, 2, 30, 0), (G_NOCORPSE | 1),
        ...
        M2_STRONG | M2_NEUTER, M3_INFRAVISIBLE | M3_FLAMING, CLR_ORANGE),
    ...
    MON("lichen", S_FUNGUS, LVL(0, 1, 9, 0, 0), (G_GENO | 4),
        ...
        M1_BREATHLESS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER, M3_NONROTTING, CLR_BRIGHT_GREEN),
    ...
    MON("legendary lichen", S_FUNGUS, LVL(4, 3, 9, 0, 0), (G_GENO | 2),
        ...
        M1_BREATHLESS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER | M2_LORD, M3_NONROTTING, HI_LORD),
...
struct permonst _mons2[] = {
    ...
    MON("green slime", S_PUDDING, LVL(6, 6, 6, 0, 0),
        ...
        M2_HOSTILE | M2_NEUTER, M3_SUMMONABLE | M3_FLAMMABLE | M3_SLIME, CLR_GREEN),
    ...
    MON("colossal slime", S_PUDDING, LVL(18, 9, 6, 0, 0),
        ...
        M1_BREATHLESS | M1_AMORPHOUS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD
            | M1_MINDLESS | M1_OMNIVORE | M1_ACID | M1_POIS,
        M2_HOSTILE | M2_NEUTER, M3_FLAMMABLE | M3_SLIME, CLR_BRIGHT_GREEN),
    /*
     * Strange beings
     */
