...
#endif
    { "kaboom", &u.uroleplay.kaboom, FALSE, DISP_IN_GAME },
...
static char def_inv_order[MAXOCLASSES] = {
    ...
    SCROLL_CLASS, SPBOOK_CLASS, POTION_CLASS, PILL_CLASS, RING_CLASS, WAND_CLASS,
...
STATIC_VAR const struct paranoia_opts {
    ...
    { PARANOID_THROW, "throw", 1, NULL, 0,
      "y to throw an arrow when you have a bow as swap weapon" },
