...
static const short grownups[][2] = {
    ...
    { PM_GREEN_LEMMING, PM_GULLY_LEMMING },
    { PM_BLUE_LEMMING, PM_GULLY_LEMMING },
    { PM_GULLY_LEMMING, PM_PLAINS_LEMMING },
    { PM_PLAINS_LEMMING, PM_PIT_LEMMING },
    { PM_LEMMING_SHAMAN, PM_MASTER_LEMMING },
    { PM_BUNGEE_LEMMING, PM_PIT_LEMMING },
    { PM_HORDE_LEMMING, PM_PIT_LEMMING },
    { PM_HIGHLAND_LEMMING, PM_PIT_LEMMING },
    { PM_LEMMING_AVIATOR, PM_PIT_LEMMING },
    { PM_SHADOW_LEMMING, PM_PIT_LEMMING },
    { PM_PIT_LEMMING, PM_HILL_LEMMING },
    { PM_HILL_LEMMING, PM_MOUNTAIN_LEMMING },
    { PM_CLIFF_LEMMING, PM_MOUNTAIN_LEMMING },
    { PM_ICE_LEMMING, PM_PEAK_LEMMING },
    { PM_MOUNTAIN_LEMMING, PM_PEAK_LEMMING },
    { PM_VOLCANO_LEMMING, PM_PEAK_LEMMING },
    { NON_PM, NON_PM }
};
