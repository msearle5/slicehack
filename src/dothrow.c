...
/* Object hits floor at hero's feet - with optional impact (breaking fragile items).
   Called from drop(), throwit(), hold_another_object() and distribute_objects(). */
void
mayhitfloor(obj, impact, x, y, verbosely)
register struct obj *obj;
boolean impact;
int x;
int y;
