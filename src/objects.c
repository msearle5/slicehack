...
AMULET("amulet versus stone",         "horseshoe", STONE_RES, 45),
...
WAND("non-functional",      "bulging",      20, 100, 0, IMMEDIATE, METAL, HI_METAL),
WAND("mysterious",          "cylindrical",   5, 100, 0, IMMEDIATE, PLASTIC, CLR_RED),
WAND("striking",            "silvery",      75, 150, 1, IMMEDIATE, SILVER, HI_SILVER),
WAND("invisibility",        "translucent",  45, 150, 1, IMMEDIATE, PLASTIC, HI_GLASS),
WAND("tangle beam",         "flashing",     25, 150, 1, IMMEDIATE, PLASTIC, CLR_RED),
WAND("speed ray",           "glowing",      50, 150, 1, IMMEDIATE, PLASTIC, CLR_BRIGHT_GREEN),
WAND("undead turning",      "dull black",   50, 150, 1, IMMEDIATE, PLASTIC, CLR_BLACK),
WAND("mutation",            "finned",       45, 200, 1, IMMEDIATE, COPPER, HI_COPPER),
WAND("cancellation",        "domed",        45, 200, 1, IMMEDIATE, PLASTIC, CLR_GRAY),
WAND("teleportation",       "spiraling",    45, 200, 1, IMMEDIATE, METAL, HI_METAL),
WAND("opening",             "flexible",     25, 150, 1, IMMEDIATE, METAL, HI_METAL),
WAND("locking",             "spiked",       25, 150, 1, IMMEDIATE, METAL, HI_METAL),
WAND("medical",             "needle-like",  25, 175, 1, IMMEDIATE, METAL, HI_METAL),
WAND("probing",             "glassy",       30, 150, 1, IMMEDIATE, GLASS, HI_GLASS),
WAND("digging",             "holographic",  55, 150, 1, RAY, PLASTIC, CLR_BRIGHT_MAGENTA),
WAND("missile",             "ribbed",       50, 150, 1, RAY, METAL, HI_METAL),
WAND("fire blast",          "red-striped",  20, 175, 1, RAY, METAL, HI_METAL),
WAND("freeze ray",          "lens-shaped",  20, 175, 1, RAY, METAL, HI_METAL),
WAND("sleep ray",           "double-ended", 50, 175, 1, RAY, METAL, HI_METAL),
WAND("death ray",           "faceted",      5, 500, 1, RAY, PLASTIC, HI_GLASS),
WAND("lightning",           "curved",       10, 175, 1, RAY, METAL, HI_METAL),
WAND("poison gas",          "mesh",         20, 175, 1, RAY, METAL, HI_METAL),
WAND("acid stream",         "twisted",      20, 175, 1, RAY, METAL, HI_METAL),
WAND("sonic boom",          "dart-shaped",  20, 175, 1, RAY, METAL, HI_METAL),
WAND("psionic",             "sparkling",    10, 175, 1, RAY, GLASS, HI_GLASS),
/* extra descriptions, shuffled into use at start of new game */
WAND(None,                  "color-shifting",0, 150, 1, 0, PLASTIC, CLR_BRIGHT_BLUE),
WAND(None,                  "dished",       0, 150, 1, 0, METAL, HI_METAL),
WAND(None,                  "toroidal",     0, 150, 1, 0, METAL, HI_METAL),
WAND(None,                  "double wedge", 0, 150, 1, 0, METAL, HI_METAL),
WAND(None,                  "vibrating",    0, 150, 1, 0, PLASTIC, CLR_MAGENTA),
WAND(None,                  "multi-hued",   0, 150, 1, 0, PLASTIC, CLR_YELLOW),
WAND(None,                  "leaf-shaped",  0, 150, 1, 0, METAL, HI_METAL),
WAND(None,                  "patterned",    0, 150, 1, 0, METAL, CLR_BLUE),
WAND(None,                  "sliding",      0, 150, 1, 0, METAL, HI_METAL),
#undef WAND
