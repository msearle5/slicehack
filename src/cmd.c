...
static const char *levltyp[] = {
    ...
    "stairs", "ladder", "fountain", "throne", "sink", "furnace", "grave", "altar", "ice",
...
struct ext_func_tab extcmdlist[] = {
    ...
    { '\0', "alchemy", "list known alchemical recipes",
            doalchemy, IFBURIED | AUTOCOMPLETE, NULL },
    ...
    { 'C', "call", "call (name) something", docallcmd, IFBURIED, NULL },
    ...
    { '\0', "exploremode", "enter explore (discovery) mode",
            enter_explore_mode, IFBURIED, NULL },
    { 'f', "fire", "fire selected ammunition", dofire, 0, NULL },
    { M('f'), "force", "force a lock", doforce, AUTOCOMPLETE, NULL },
    { M('g'), "give", "give another creature an item", dogive, AUTOCOMPLETE, NULL },
    ...
    { '\0', "portdebug", "wizard port debug command",
            wiz_port_debug, IFBURIED | AUTOCOMPLETE | WIZMODECMD, NULL },
#endif
    ...
    { 'Q', "quiver", "select ammunition", dowieldquiver, 0, NULL },
...
#ifdef SHELL
    { '!', "shell", "do a shell escape", dosh, IFBURIED | GENERALCMD, NULL },
#endif /* SHELL */
